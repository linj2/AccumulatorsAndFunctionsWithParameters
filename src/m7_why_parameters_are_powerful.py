...
def test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    # test1
    even_better_draw_circles(10,10,0.5)

    # test2
    even_better_draw_circles(20,5,0.05)

    # test3
    even_better_draw_circles(55,1,0.1)


def even_better_draw_circles(numcir,rad,speed):
    window = rg.RoseWindow(400, 400)

    center = rg.Point(200, 200)
    for k in range(numcir+1):
